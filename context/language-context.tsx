...
const translations: Translations = {
  ko: {
    ...
    saveCompleteWeb: '이미지가 다운로드 되었습니다',
  ...
  en: {
    ...
    appSubtitle: 'Ratio Crop & Filter Editor',
    supportRatios: 'Supported Ratios',
    highQuality: 'High Quality',
    standardQuality: 'Standard Quality',
    standardQualityDesc: 'Fast save in standard resolution.',
    highQualityDesc: 'Save in best quality. (Watch Ad)',
    saveOptions: 'Save Options',
    saveResolution: 'Choose save quality',
    saveSuccess: 'Saved Successfully!',
    saveCompleteTitle: 'Save Complete!',
    saveCompleteWeb: 'Image has been downloaded',
